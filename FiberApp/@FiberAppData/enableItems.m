...
filterParam = findobj('Enable', 'off', '-and', 'Parent', ...
    findobj('Type', 'uipanel', 'Tag', 'ImageFiltering'));
set([menuItems; toolbarItems; imParam; maskParam; fibTrackParam; filterParam], ...
    'Enable', 'on');
